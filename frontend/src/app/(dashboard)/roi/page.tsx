      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <MetricCard label="Avg ROI" value={formatPct(avgRoi)} loading={isLoading} />
            <MetricCard label="Median ROI" value={formatPct(medianRoi)} loading={isLoading} />
            <MetricCard
              label="Best ROI"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <CardContent>
                {isLoading ? <TableSkeleton rows={5} /> : <DataTable columns={roiColumns} data={top10} />}
            </CardContent>
          </Card>
            ...
            <CardContent>
                {isLoading ? <TableSkeleton rows={5} /> : <DataTable columns={roiColumns} data={bottom10} />}
            </CardContent>
          </Card>
          </div>
