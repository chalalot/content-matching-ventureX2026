    ...
    <div>
      ...
      <Tabs defaultValue="directors">
        ...
        <TabsContent value="directors" className="flex flex-col gap-6">
          ...
          <CardContent>
              {isLoading ? <TableSkeleton /> : <DataTable columns={directorColumns} data={directors} maxRows={50} />}
          </CardContent>
        </Card>
        </TabsContent>
        ...
        <TabsContent value="kols" className="flex flex-col gap-6">
          ...
          <CardContent>
              {isLoading ? <TableSkeleton /> : <DataTable columns={kolColumns} data={kols} maxRows={50} />}
          </CardContent>
        </Card>
        </TabsContent>
      </Tabs>
